...
main()
	{
		int opcion,numero=1,temporal=0,a;
		...
		do
		{
				...
				switch(opcion)
											...
											switch(caracter)
												{
														...
														cout<<"                           		ingrese el primer numero para restar:   ";
														cin>>numero1;
														cout<<"                           		ingrese el segundo numero para restar:   ";
														cin>>numero2;
														...
														cin>>numero1;
														cout<<"                           		ingrese el segundo numero para multiplicar:   ";
														cin>>numero2;
														...
														cout<<"                           		ingrese el dato para la raiz:   ";
														cin>>numero1;
														raiz=sqrt(numero1);
														...
														cin>>numero2;										
														if (numero2==0)
														{cout<<"								Digite otra vez el dato dos: ";
														cin>>numero2;}
														...
														default:
														cout<<"\n					LA OPCION SELECCIONADA NO PERTENECE A LAS OPCIONES DEL MENU \n\n";
														break;
												}
												
												
												
											cout<<"\n                                       Desea continuar en las operaciones? Digite S o s ";
											cin>>entrada2;
										}
					...
					cout<<"\n				Desea continuar en el MENU PRINCIPAL? ingrese el caracter s o S ";
					cin>>entrada;
		}
