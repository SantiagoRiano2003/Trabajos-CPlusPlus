...
void buscar()
{
	cout<<"La Opcion que Elegiste Fue buscar"<<endl;
	ifstream leer;
	...
	if (leer.is_open())
	{
		...
		if(encontrado==false)
		{
			cout<<"No hay registros con esa clave"<<auxclave<<endl;
		}
	}
	else
	{
...
void modificar()
{
	...
	ifstream leer;
	encontrado=false;
	int auxclave,auxsemestre,opcion,auxedad;
	char auxgrupo[20],auxnombre[20];
	...
	if(aux.is_open() && leer.is_open())
	{
		...
		if(auxclave==clave)
			...
			cout<<"					"<<endl;
			cout<<"					----------------------------------"<<endl;
			cout<<"					Ingrese un digito para cambiar:"   <<clave<<endl;
			cout<<"					1) Clave:"   <<endl;
			cout<<"					2) Nombre:"  <<endl;
			cout<<"					3) Semestre:"<<endl;
			cout<<"					4) Grupo:"   <<endl;
			cout<<"					5) Edad:"    <<endl;
			cout<<"					----------------------------------"<<endl;
			cin>>opcion;
			...
			{
				case 1: 
				cout<<"	        Ingresa la nueva clave del aprendiz :"<<clave<<endl;
				cin>>auxclave;
				aux<<auxclave<<" "<<nombre<<" "<<semestre<<" "<<grupo<<" "<<edad<<endl;
				break;
				
				case 2: 
				cout<<"	        Ingresa el nuevo nombre del aprendiz :"<<clave<<endl;
				cin>>auxnombre;
				aux<<clave<<" "<<auxnombre<<" "<<semestre<<" "<<grupo<<" "<<edad<<endl;
				break;
				
				case 3:
				cout<<"	        Ingresa el nuevo semestre del aprendiz :"<<clave<<endl;
				cin>>auxsemestre;
				aux<<clave<<" "<<nombre<<" "<<auxsemestre<<" "<<grupo<<" "<<edad<<endl;
				break;
				
				case 4:
				cout<<"	        Ingresa el nuevo grupo del aprendiz :"<<clave<<endl;
				cin>>auxgrupo;
				aux<<clave<<" "<<nombre<<" "<<semestre<<" "<<auxgrupo<<" "<<edad<<endl;
				break;
				
				case 5:
				cout<<"	        Ingresa la nuevo edad del aprendiz :"<<clave<<endl;
				cin>>auxedad;
...
void salir()
{
	...
	cout<<endl<<endl<<endl<<"\t\t\t\t\tAdios... Programa finalizado";
}
